...
public class BenfordsLaw {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        // Calculate frequencies which will be array where index is digit and value is frequency of that digit (%)
        ArrayList<String> sales = readSalesFromCsvFile();
        double[] frequencies = calculateFrequencies(sales);

        // Numeric and visual representation of frequencies of digits from 1 - 9 from sales
        ...
        while (readerFile.hasNext()) {
            ...
            if (!data.isEmpty()) {
                ...
                if (splitData.length == 2 && isNumeric(splitData[1])) {
                    ...
                    salesDataArray.add(splitData[1]);
                }
            }
        }
    ...
    /***
      * Takes sales that were read in from .csv and will calculate the first digit frequencies of those sales
      * as a percentage of all digits. The resulting double[] will be digit -> frequency.
      * Example: frequencies[1] is the frequency of first digit being 1.
      *
    ...
    public static double[] calculateFrequencies(ArrayList<String> sales) {
        ...
        // Calculate the frequencies of each first digit (1 - 9) which is occurrences / total
    ...
    public static void createVisualRepresentation(double[] frequencies) {
        ...
        // Create JFrame and add chart panel to it, closing it does not terminal program, then set it to be visible
